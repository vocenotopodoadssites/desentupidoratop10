      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((s, idx) => (
          <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-red-100 transition-all group">
            ...
            <a href="https://wa.me/5519996665646" className="inline-flex items-center gap-2 text-red-600 font-bold hover:gap-3 transition-all">
        ...
        <div className="bg-red-600 p-8 rounded-2xl shadow-xl flex flex-col justify-center text-center text-white">
          ...
          <a href="https://wa.me/5519996665646" className="bg-white text-red-600 font-bold py-3 rounded-xl hover:bg-gray-100 transition-colors">
            Falar com Técnico
          </a>
        </div>
      </div>
